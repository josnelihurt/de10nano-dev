	soc_system u0 (
		.axi_conduit_merger_0_conduit_end_awcache (<connected-to-axi_conduit_merger_0_conduit_end_awcache>), // axi_conduit_merger_0_conduit_end.awcache
		.axi_conduit_merger_0_conduit_end_awprot  (<connected-to-axi_conduit_merger_0_conduit_end_awprot>),  //                                 .awprot
		.axi_conduit_merger_0_conduit_end_awuser  (<connected-to-axi_conduit_merger_0_conduit_end_awuser>),  //                                 .awuser
		.axi_conduit_merger_0_conduit_end_arcache (<connected-to-axi_conduit_merger_0_conduit_end_arcache>), //                                 .arcache
		.axi_conduit_merger_0_conduit_end_aruser  (<connected-to-axi_conduit_merger_0_conduit_end_aruser>),  //                                 .aruser
		.axi_conduit_merger_0_conduit_end_arprot  (<connected-to-axi_conduit_merger_0_conduit_end_arprot>),  //                                 .arprot
		...
		.custom_ip_io_leds_bus                    (<connected-to-custom_ip_io_leds_bus>),                    //                     custom_ip_io.leds_bus
		.custom_ip_io_vga_bus_r                   (<connected-to-custom_ip_io_vga_bus_r>),                   //                                 .vga_bus_r
		.custom_ip_io_vga_bus_g                   (<connected-to-custom_ip_io_vga_bus_g>),                   //                                 .vga_bus_g
		.custom_ip_io_vga_bus_b                   (<connected-to-custom_ip_io_vga_bus_b>),                   //                                 .vga_bus_b
		.custom_ip_io_vga_hs                      (<connected-to-custom_ip_io_vga_hs>),                      //                                 .vga_hs
		.custom_ip_io_vga_vs                      (<connected-to-custom_ip_io_vga_vs>)                       //                                 .vga_vs
	);
