...
module soc_system_mm_interconnect_3 (
		...
		output wire [5:0]   onchip_memory2_0_s2_address,             //               onchip_memory2_0_s2.address
	...
	wire          dma_0_write_master_translator_avalon_universal_master_0_waitrequest;   // onchip_memory2_0_s2_translator:uav_waitrequest -> dma_0_write_master_translator:uav_waitrequest
	wire  [127:0] dma_0_write_master_translator_avalon_universal_master_0_readdata;      // onchip_memory2_0_s2_translator:uav_readdata -> dma_0_write_master_translator:uav_readdata
	wire          dma_0_write_master_translator_avalon_universal_master_0_debugaccess;   // dma_0_write_master_translator:uav_debugaccess -> onchip_memory2_0_s2_translator:uav_debugaccess
	wire    [9:0] dma_0_write_master_translator_avalon_universal_master_0_address;       // dma_0_write_master_translator:uav_address -> onchip_memory2_0_s2_translator:uav_address
	wire          dma_0_write_master_translator_avalon_universal_master_0_read;          // dma_0_write_master_translator:uav_read -> onchip_memory2_0_s2_translator:uav_read
	wire   [15:0] dma_0_write_master_translator_avalon_universal_master_0_byteenable;    // dma_0_write_master_translator:uav_byteenable -> onchip_memory2_0_s2_translator:uav_byteenable
	wire          dma_0_write_master_translator_avalon_universal_master_0_readdatavalid; // onchip_memory2_0_s2_translator:uav_readdatavalid -> dma_0_write_master_translator:uav_readdatavalid
	wire          dma_0_write_master_translator_avalon_universal_master_0_lock;          // dma_0_write_master_translator:uav_lock -> onchip_memory2_0_s2_translator:uav_lock
	wire          dma_0_write_master_translator_avalon_universal_master_0_write;         // dma_0_write_master_translator:uav_write -> onchip_memory2_0_s2_translator:uav_write
	wire  [127:0] dma_0_write_master_translator_avalon_universal_master_0_writedata;     // dma_0_write_master_translator:uav_writedata -> onchip_memory2_0_s2_translator:uav_writedata
	wire    [4:0] dma_0_write_master_translator_avalon_universal_master_0_burstcount;    // dma_0_write_master_translator:uav_burstcount -> onchip_memory2_0_s2_translator:uav_burstcount
