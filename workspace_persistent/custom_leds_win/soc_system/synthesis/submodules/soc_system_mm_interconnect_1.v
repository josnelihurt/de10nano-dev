...
module soc_system_mm_interconnect_1 (
		...
		input  wire         custom_ip_reset_reset_bridge_in_reset_reset,                      //                      custom_ip_reset_reset_bridge_in_reset.reset
		...
		output wire [0:0]   custom_ip_avs_s0_address,                                         //                                           custom_ip_avs_s0.address
		output wire         custom_ip_avs_s0_write,                                           //                                                           .write
		output wire         custom_ip_avs_s0_read,                                            //                                                           .read
		input  wire [31:0]  custom_ip_avs_s0_readdata,                                        //                                                           .readdata
		output wire [31:0]  custom_ip_avs_s0_writedata,                                       //                                                           .writedata
	...
	wire   [31:0] custom_ip_avs_s0_agent_m0_readdata;                           // custom_ip_avs_s0_translator:uav_readdata -> custom_ip_avs_s0_agent:m0_readdata
	wire          custom_ip_avs_s0_agent_m0_waitrequest;                        // custom_ip_avs_s0_translator:uav_waitrequest -> custom_ip_avs_s0_agent:m0_waitrequest
	wire          custom_ip_avs_s0_agent_m0_debugaccess;                        // custom_ip_avs_s0_agent:m0_debugaccess -> custom_ip_avs_s0_translator:uav_debugaccess
	wire   [29:0] custom_ip_avs_s0_agent_m0_address;                            // custom_ip_avs_s0_agent:m0_address -> custom_ip_avs_s0_translator:uav_address
	wire    [3:0] custom_ip_avs_s0_agent_m0_byteenable;                         // custom_ip_avs_s0_agent:m0_byteenable -> custom_ip_avs_s0_translator:uav_byteenable
	wire          custom_ip_avs_s0_agent_m0_read;                               // custom_ip_avs_s0_agent:m0_read -> custom_ip_avs_s0_translator:uav_read
	wire          custom_ip_avs_s0_agent_m0_readdatavalid;                      // custom_ip_avs_s0_translator:uav_readdatavalid -> custom_ip_avs_s0_agent:m0_readdatavalid
	wire          custom_ip_avs_s0_agent_m0_lock;                               // custom_ip_avs_s0_agent:m0_lock -> custom_ip_avs_s0_translator:uav_lock
	wire   [31:0] custom_ip_avs_s0_agent_m0_writedata;                          // custom_ip_avs_s0_agent:m0_writedata -> custom_ip_avs_s0_translator:uav_writedata
	wire          custom_ip_avs_s0_agent_m0_write;                              // custom_ip_avs_s0_agent:m0_write -> custom_ip_avs_s0_translator:uav_write
	wire    [2:0] custom_ip_avs_s0_agent_m0_burstcount;                         // custom_ip_avs_s0_agent:m0_burstcount -> custom_ip_avs_s0_translator:uav_burstcount
	wire          custom_ip_avs_s0_agent_rf_source_valid;                       // custom_ip_avs_s0_agent:rf_source_valid -> custom_ip_avs_s0_agent_rsp_fifo:in_valid
	wire  [127:0] custom_ip_avs_s0_agent_rf_source_data;                        // custom_ip_avs_s0_agent:rf_source_data -> custom_ip_avs_s0_agent_rsp_fifo:in_data
	wire          custom_ip_avs_s0_agent_rf_source_ready;                       // custom_ip_avs_s0_agent_rsp_fifo:in_ready -> custom_ip_avs_s0_agent:rf_source_ready
	wire          custom_ip_avs_s0_agent_rf_source_startofpacket;               // custom_ip_avs_s0_agent:rf_source_startofpacket -> custom_ip_avs_s0_agent_rsp_fifo:in_startofpacket
	wire          custom_ip_avs_s0_agent_rf_source_endofpacket;                 // custom_ip_avs_s0_agent:rf_source_endofpacket -> custom_ip_avs_s0_agent_rsp_fifo:in_endofpacket
	wire          custom_ip_avs_s0_agent_rsp_fifo_out_valid;                    // custom_ip_avs_s0_agent_rsp_fifo:out_valid -> custom_ip_avs_s0_agent:rf_sink_valid
	wire  [127:0] custom_ip_avs_s0_agent_rsp_fifo_out_data;                     // custom_ip_avs_s0_agent_rsp_fifo:out_data -> custom_ip_avs_s0_agent:rf_sink_data
	wire          custom_ip_avs_s0_agent_rsp_fifo_out_ready;                    // custom_ip_avs_s0_agent:rf_sink_ready -> custom_ip_avs_s0_agent_rsp_fifo:out_ready
	wire          custom_ip_avs_s0_agent_rsp_fifo_out_startofpacket;            // custom_ip_avs_s0_agent_rsp_fifo:out_startofpacket -> custom_ip_avs_s0_agent:rf_sink_startofpacket
	wire          custom_ip_avs_s0_agent_rsp_fifo_out_endofpacket;              // custom_ip_avs_s0_agent_rsp_fifo:out_endofpacket -> custom_ip_avs_s0_agent:rf_sink_endofpacket
	wire          custom_ip_avs_s0_agent_rdata_fifo_src_valid;                  // custom_ip_avs_s0_agent:rdata_fifo_src_valid -> custom_ip_avs_s0_agent_rdata_fifo:in_valid
	wire   [33:0] custom_ip_avs_s0_agent_rdata_fifo_src_data;                   // custom_ip_avs_s0_agent:rdata_fifo_src_data -> custom_ip_avs_s0_agent_rdata_fifo:in_data
	wire          custom_ip_avs_s0_agent_rdata_fifo_src_ready;                  // custom_ip_avs_s0_agent_rdata_fifo:in_ready -> custom_ip_avs_s0_agent:rdata_fifo_src_ready
	...
	wire  [235:0] onchip_memory2_0_s1_agent_rf_source_data;                     // onchip_memory2_0_s1_agent:rf_source_data -> onchip_memory2_0_s1_agent_rsp_fifo:in_data
	...
	wire  [235:0] onchip_memory2_0_s1_agent_rsp_fifo_out_data;                  // onchip_memory2_0_s1_agent_rsp_fifo:out_data -> onchip_memory2_0_s1_agent:rf_sink_data
	...
	wire          custom_ip_avs_s0_agent_rp_valid;                              // custom_ip_avs_s0_agent:rp_valid -> router_002:sink_valid
	wire  [126:0] custom_ip_avs_s0_agent_rp_data;                               // custom_ip_avs_s0_agent:rp_data -> router_002:sink_data
	wire          custom_ip_avs_s0_agent_rp_ready;                              // router_002:sink_ready -> custom_ip_avs_s0_agent:rp_ready
	wire          custom_ip_avs_s0_agent_rp_startofpacket;                      // custom_ip_avs_s0_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          custom_ip_avs_s0_agent_rp_endofpacket;                        // custom_ip_avs_s0_agent:rp_endofpacket -> router_002:sink_endofpacket
	wire          dma_0_control_port_slave_agent_rp_valid;                      // dma_0_control_port_slave_agent:rp_valid -> router_003:sink_valid
	wire  [126:0] dma_0_control_port_slave_agent_rp_data;                       // dma_0_control_port_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [234:0] onchip_memory2_0_s1_agent_rp_data;                            // onchip_memory2_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire          custom_ip_avs_s0_burst_adapter_source0_valid;                 // custom_ip_avs_s0_burst_adapter:source0_valid -> custom_ip_avs_s0_agent:cp_valid
	wire  [126:0] custom_ip_avs_s0_burst_adapter_source0_data;                  // custom_ip_avs_s0_burst_adapter:source0_data -> custom_ip_avs_s0_agent:cp_data
	wire          custom_ip_avs_s0_burst_adapter_source0_ready;                 // custom_ip_avs_s0_agent:cp_ready -> custom_ip_avs_s0_burst_adapter:source0_ready
	wire    [2:0] custom_ip_avs_s0_burst_adapter_source0_channel;               // custom_ip_avs_s0_burst_adapter:source0_channel -> custom_ip_avs_s0_agent:cp_channel
	wire          custom_ip_avs_s0_burst_adapter_source0_startofpacket;         // custom_ip_avs_s0_burst_adapter:source0_startofpacket -> custom_ip_avs_s0_agent:cp_startofpacket
	wire          custom_ip_avs_s0_burst_adapter_source0_endofpacket;           // custom_ip_avs_s0_burst_adapter:source0_endofpacket -> custom_ip_avs_s0_agent:cp_endofpacket
	...
	wire  [234:0] cmd_mux_002_src_data;                                         // cmd_mux_002:src_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	...
	wire  [234:0] onchip_memory2_0_s1_burst_adapter_source0_data;               // onchip_memory2_0_s1_burst_adapter:source0_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire          router_002_src_valid;                                         // router_002:src_valid -> custom_ip_avs_s0_rsp_width_adapter:in_valid
	wire  [126:0] router_002_src_data;                                          // router_002:src_data -> custom_ip_avs_s0_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                         // custom_ip_avs_s0_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [2:0] router_002_src_channel;                                       // router_002:src_channel -> custom_ip_avs_s0_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                                 // router_002:src_startofpacket -> custom_ip_avs_s0_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                                   // router_002:src_endofpacket -> custom_ip_avs_s0_rsp_width_adapter:in_endofpacket
	wire          custom_ip_avs_s0_rsp_width_adapter_src_valid;                 // custom_ip_avs_s0_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [234:0] custom_ip_avs_s0_rsp_width_adapter_src_data;                  // custom_ip_avs_s0_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          custom_ip_avs_s0_rsp_width_adapter_src_ready;                 // rsp_demux:sink_ready -> custom_ip_avs_s0_rsp_width_adapter:out_ready
	wire    [2:0] custom_ip_avs_s0_rsp_width_adapter_src_channel;               // custom_ip_avs_s0_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          custom_ip_avs_s0_rsp_width_adapter_src_startofpacket;         // custom_ip_avs_s0_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          custom_ip_avs_s0_rsp_width_adapter_src_endofpacket;           // custom_ip_avs_s0_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	wire          router_003_src_valid;                                         // router_003:src_valid -> dma_0_control_port_slave_rsp_width_adapter:in_valid
	wire  [126:0] router_003_src_data;                                          // router_003:src_data -> dma_0_control_port_slave_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                         // dma_0_control_port_slave_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [2:0] router_003_src_channel;                                       // router_003:src_channel -> dma_0_control_port_slave_rsp_width_adapter:in_channel
	wire          router_003_src_startofpacket;                                 // router_003:src_startofpacket -> dma_0_control_port_slave_rsp_width_adapter:in_startofpacket
	wire          router_003_src_endofpacket;                                   // router_003:src_endofpacket -> dma_0_control_port_slave_rsp_width_adapter:in_endofpacket
	wire          dma_0_control_port_slave_rsp_width_adapter_src_valid;         // dma_0_control_port_slave_rsp_width_adapter:out_valid -> rsp_demux_001:sink_valid
	wire  [234:0] dma_0_control_port_slave_rsp_width_adapter_src_data;          // dma_0_control_port_slave_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire          dma_0_control_port_slave_rsp_width_adapter_src_ready;         // rsp_demux_001:sink_ready -> dma_0_control_port_slave_rsp_width_adapter:out_ready
	wire    [2:0] dma_0_control_port_slave_rsp_width_adapter_src_channel;       // dma_0_control_port_slave_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	wire          dma_0_control_port_slave_rsp_width_adapter_src_startofpacket; // dma_0_control_port_slave_rsp_width_adapter:out_startofpacket -> rsp_demux_001:sink_startofpacket
	wire          dma_0_control_port_slave_rsp_width_adapter_src_endofpacket;   // dma_0_control_port_slave_rsp_width_adapter:out_endofpacket -> rsp_demux_001:sink_endofpacket
	wire          cmd_mux_src_valid;                                            // cmd_mux:src_valid -> custom_ip_avs_s0_cmd_width_adapter:in_valid
	wire  [234:0] cmd_mux_src_data;                                             // cmd_mux:src_data -> custom_ip_avs_s0_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                            // custom_ip_avs_s0_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [2:0] cmd_mux_src_channel;                                          // cmd_mux:src_channel -> custom_ip_avs_s0_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                                    // cmd_mux:src_startofpacket -> custom_ip_avs_s0_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                                      // cmd_mux:src_endofpacket -> custom_ip_avs_s0_cmd_width_adapter:in_endofpacket
	wire          custom_ip_avs_s0_cmd_width_adapter_src_valid;                 // custom_ip_avs_s0_cmd_width_adapter:out_valid -> custom_ip_avs_s0_burst_adapter:sink0_valid
	wire  [126:0] custom_ip_avs_s0_cmd_width_adapter_src_data;                  // custom_ip_avs_s0_cmd_width_adapter:out_data -> custom_ip_avs_s0_burst_adapter:sink0_data
	wire          custom_ip_avs_s0_cmd_width_adapter_src_ready;                 // custom_ip_avs_s0_burst_adapter:sink0_ready -> custom_ip_avs_s0_cmd_width_adapter:out_ready
	wire    [2:0] custom_ip_avs_s0_cmd_width_adapter_src_channel;               // custom_ip_avs_s0_cmd_width_adapter:out_channel -> custom_ip_avs_s0_burst_adapter:sink0_channel
	wire          custom_ip_avs_s0_cmd_width_adapter_src_startofpacket;         // custom_ip_avs_s0_cmd_width_adapter:out_startofpacket -> custom_ip_avs_s0_burst_adapter:sink0_startofpacket
	wire          custom_ip_avs_s0_cmd_width_adapter_src_endofpacket;           // custom_ip_avs_s0_cmd_width_adapter:out_endofpacket -> custom_ip_avs_s0_burst_adapter:sink0_endofpacket
	wire          cmd_mux_001_src_valid;                                        // cmd_mux_001:src_valid -> dma_0_control_port_slave_cmd_width_adapter:in_valid
	wire  [234:0] cmd_mux_001_src_data;                                         // cmd_mux_001:src_data -> dma_0_control_port_slave_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                        // dma_0_control_port_slave_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [2:0] cmd_mux_001_src_channel;                                      // cmd_mux_001:src_channel -> dma_0_control_port_slave_cmd_width_adapter:in_channel
	wire          cmd_mux_001_src_startofpacket;                                // cmd_mux_001:src_startofpacket -> dma_0_control_port_slave_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                  // cmd_mux_001:src_endofpacket -> dma_0_control_port_slave_cmd_width_adapter:in_endofpacket
	...
	wire          custom_ip_avs_s0_agent_rdata_fifo_out_valid;                  // custom_ip_avs_s0_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] custom_ip_avs_s0_agent_rdata_fifo_out_data;                   // custom_ip_avs_s0_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          custom_ip_avs_s0_agent_rdata_fifo_out_ready;                  // avalon_st_adapter:in_0_ready -> custom_ip_avs_s0_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                                // avalon_st_adapter:out_0_valid -> custom_ip_avs_s0_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                                 // avalon_st_adapter:out_0_data -> custom_ip_avs_s0_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                // custom_ip_avs_s0_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                // avalon_st_adapter:out_0_error -> custom_ip_avs_s0_agent:rdata_fifo_sink_error
	...
	wire  [129:0] onchip_memory2_0_s1_agent_rdata_fifo_out_data;                // onchip_memory2_0_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	...
	wire  [129:0] avalon_st_adapter_002_out_0_data;                             // avalon_st_adapter_002:out_0_data -> onchip_memory2_0_s1_agent:rdata_fifo_sink_data
	...
	) custom_ip_avs_s0_translator (
		.clk                    (clk_0_clk_clk),                               //                      clk.clk
		.reset                  (custom_ip_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (custom_ip_avs_s0_agent_m0_address),           // avalon_universal_slave_0.address
		.uav_burstcount         (custom_ip_avs_s0_agent_m0_burstcount),        //                         .burstcount
		.uav_read               (custom_ip_avs_s0_agent_m0_read),              //                         .read
		.uav_write              (custom_ip_avs_s0_agent_m0_write),             //                         .write
		.uav_waitrequest        (custom_ip_avs_s0_agent_m0_waitrequest),       //                         .waitrequest
		.uav_readdatavalid      (custom_ip_avs_s0_agent_m0_readdatavalid),     //                         .readdatavalid
		.uav_byteenable         (custom_ip_avs_s0_agent_m0_byteenable),        //                         .byteenable
		.uav_readdata           (custom_ip_avs_s0_agent_m0_readdata),          //                         .readdata
		.uav_writedata          (custom_ip_avs_s0_agent_m0_writedata),         //                         .writedata
		.uav_lock               (custom_ip_avs_s0_agent_m0_lock),              //                         .lock
		.uav_debugaccess        (custom_ip_avs_s0_agent_m0_debugaccess),       //                         .debugaccess
		.av_address             (custom_ip_avs_s0_address),                    //      avalon_anti_slave_0.address
		.av_write               (custom_ip_avs_s0_write),                      //                         .write
		.av_read                (custom_ip_avs_s0_read),                       //                         .read
		.av_readdata            (custom_ip_avs_s0_readdata),                   //                         .readdata
		.av_writedata           (custom_ip_avs_s0_writedata),                  //                         .writedata
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) custom_ip_avs_s0_agent (
		.clk                     (clk_0_clk_clk),                                        //             clk.clk
		.reset                   (custom_ip_reset_reset_bridge_in_reset_reset),          //       clk_reset.reset
		.m0_address              (custom_ip_avs_s0_agent_m0_address),                    //              m0.address
		.m0_burstcount           (custom_ip_avs_s0_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (custom_ip_avs_s0_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (custom_ip_avs_s0_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (custom_ip_avs_s0_agent_m0_lock),                       //                .lock
		.m0_readdata             (custom_ip_avs_s0_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (custom_ip_avs_s0_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (custom_ip_avs_s0_agent_m0_read),                       //                .read
		.m0_waitrequest          (custom_ip_avs_s0_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (custom_ip_avs_s0_agent_m0_writedata),                  //                .writedata
		.m0_write                (custom_ip_avs_s0_agent_m0_write),                      //                .write
		.rp_endofpacket          (custom_ip_avs_s0_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (custom_ip_avs_s0_agent_rp_ready),                      //                .ready
		.rp_valid                (custom_ip_avs_s0_agent_rp_valid),                      //                .valid
		.rp_data                 (custom_ip_avs_s0_agent_rp_data),                       //                .data
		.rp_startofpacket        (custom_ip_avs_s0_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (custom_ip_avs_s0_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (custom_ip_avs_s0_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (custom_ip_avs_s0_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (custom_ip_avs_s0_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (custom_ip_avs_s0_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (custom_ip_avs_s0_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (custom_ip_avs_s0_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (custom_ip_avs_s0_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (custom_ip_avs_s0_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (custom_ip_avs_s0_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (custom_ip_avs_s0_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (custom_ip_avs_s0_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (custom_ip_avs_s0_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (custom_ip_avs_s0_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (custom_ip_avs_s0_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (custom_ip_avs_s0_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                        // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                        //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                         //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                        //                .error
		.rdata_fifo_src_ready    (custom_ip_avs_s0_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (custom_ip_avs_s0_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (custom_ip_avs_s0_agent_rdata_fifo_src_data),           //                .data
	...
	) custom_ip_avs_s0_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                     //       clk.clk
		.reset             (custom_ip_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
		.in_data           (custom_ip_avs_s0_agent_rf_source_data),             //        in.data
		.in_valid          (custom_ip_avs_s0_agent_rf_source_valid),            //          .valid
		.in_ready          (custom_ip_avs_s0_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (custom_ip_avs_s0_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (custom_ip_avs_s0_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (custom_ip_avs_s0_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (custom_ip_avs_s0_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (custom_ip_avs_s0_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (custom_ip_avs_s0_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (custom_ip_avs_s0_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) custom_ip_avs_s0_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                               //       clk.clk
		.reset             (custom_ip_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (custom_ip_avs_s0_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (custom_ip_avs_s0_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (custom_ip_avs_s0_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (custom_ip_avs_s0_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (custom_ip_avs_s0_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (custom_ip_avs_s0_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	soc_system_mm_interconnect_1_router_002 router_002 (
		.sink_ready         (custom_ip_avs_s0_agent_rp_ready),             //      sink.ready
		.sink_valid         (custom_ip_avs_s0_agent_rp_valid),             //          .valid
		.sink_data          (custom_ip_avs_s0_agent_rp_data),              //          .data
		.sink_startofpacket (custom_ip_avs_s0_agent_rp_startofpacket),     //          .startofpacket
		.sink_endofpacket   (custom_ip_avs_s0_agent_rp_endofpacket),       //          .endofpacket
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (custom_ip_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	) custom_ip_avs_s0_burst_adapter (
		.clk                   (clk_0_clk_clk),                                        //       cr0.clk
		.reset                 (custom_ip_reset_reset_bridge_in_reset_reset),          // cr0_reset.reset
		.sink0_valid           (custom_ip_avs_s0_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (custom_ip_avs_s0_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (custom_ip_avs_s0_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (custom_ip_avs_s0_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (custom_ip_avs_s0_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (custom_ip_avs_s0_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (custom_ip_avs_s0_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (custom_ip_avs_s0_burst_adapter_source0_data),          //          .data
		.source0_channel       (custom_ip_avs_s0_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (custom_ip_avs_s0_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (custom_ip_avs_s0_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (custom_ip_avs_s0_burst_adapter_source0_ready)          //          .ready
	);
	...
	soc_system_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                        //       clk.clk
		.reset              (custom_ip_reset_reset_bridge_in_reset_reset),          // clk_reset.reset
		.sink_ready         (custom_ip_avs_s0_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (custom_ip_avs_s0_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (custom_ip_avs_s0_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (custom_ip_avs_s0_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (custom_ip_avs_s0_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (custom_ip_avs_s0_rsp_width_adapter_src_valid),         //          .valid
	...
	altera_merlin_width_adapter #(
	...
	) custom_ip_avs_s0_rsp_width_adapter (
		.clk                  (clk_0_clk_clk),                                        //       clk.clk
		.reset                (custom_ip_reset_reset_bridge_in_reset_reset),          // clk_reset.reset
		...
		.out_endofpacket      (custom_ip_avs_s0_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (custom_ip_avs_s0_rsp_width_adapter_src_data),          //          .data
		.out_channel          (custom_ip_avs_s0_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (custom_ip_avs_s0_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (custom_ip_avs_s0_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (custom_ip_avs_s0_rsp_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (0),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) custom_ip_avs_s0_cmd_width_adapter (
		.clk                  (clk_0_clk_clk),                                        //       clk.clk
		.reset                (custom_ip_reset_reset_bridge_in_reset_reset),          // clk_reset.reset
		...
		.out_endofpacket      (custom_ip_avs_s0_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (custom_ip_avs_s0_cmd_width_adapter_src_data),          //          .data
		.out_channel          (custom_ip_avs_s0_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (custom_ip_avs_s0_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (custom_ip_avs_s0_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (custom_ip_avs_s0_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                // (terminated)
	);
	...
	soc_system_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_rst_0_reset (custom_ip_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (custom_ip_avs_s0_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (custom_ip_avs_s0_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (custom_ip_avs_s0_agent_rdata_fifo_out_ready), //         .ready
